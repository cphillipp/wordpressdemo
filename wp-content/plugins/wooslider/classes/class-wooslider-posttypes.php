...
class WooSlider_PostTypes {
	...
	private function setup_post_type_labels_base () {
		...
		$this->labels['slide'] = array( 'singular' => __( 'Slide', 'wooslider' ), 'plural' => __( 'Slides', 'wooslider' ), 'menu' => __( 'FlexSlider WP', 'wooslider' ) );
	...
	/**
	 * Remove the WooFramework meta box from the "Sliders" admin screens.
	 * @since  1.0.0
	 * @return void
	 */
	public function remove_wooframework_metabox () {
		remove_meta_box( 'woothemes-settings', 'slide', 'normal' );
	} // End remove_wooframework_metabox()
