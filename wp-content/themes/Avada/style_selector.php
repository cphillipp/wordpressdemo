...
jQuery(document).ready(function() {
	...
	jQuery('.patterns a').click(function(e) {
		...
		jQuery('body').css('background-image', 'url(<?php bloginfo("template_directory"); ?>/images/patterns/'+name+'.png)');
		} else {
...
<div id="style_selector">
	...
	<div class="box-title">Layout Style</div>
	<div class="input-box">
		<div class="input">
			<select name="layout">
				<option>Wide</option>
	...
	<div class="box-title">Predefined Colors</div>
	<div class="images predefined">
		...
		<p style="margin:0;line-height:normal;margin-left:-10px;"><small>These are just examples and you can build your own color scheme in the backend.</small></p>
	</div>
	</div>
