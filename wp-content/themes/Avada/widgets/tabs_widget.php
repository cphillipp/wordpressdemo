...
class Pyre_Tabs_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		$show_recent_posts = isset($instance['show_popular_posts']) ? 'true' : 'false';
		...
		<div class="tab-holder">
			<div class="tab-hold tabs-wrapper">
				<ul id="tabs" class="tabset tabs">
					...
					<li><a href="#tab1"><?php _e('Popular', 'Crucio'); ?></a></li>
					<?php endif; ?>
					<?php if($show_recent_posts == 'true'): ?>
					<li><a href="#tab2"><?php _e('Recent', 'Crucio'); ?></a></li>
					<?php endif; ?>
					<?php if($show_comments == 'true'): ?>
					<li><a href="#tab3"><img src="<?php bloginfo('template_directory'); ?>/images/speech-bubble.png" alt="Comments" /></a></li>
					<?php endif; ?>
				</ul>
